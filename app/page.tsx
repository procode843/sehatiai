  ...
  return (
    ...
    <div className="min-h-screen bg-white" dir="rtl">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className={`transition-all duration-1000 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
            ...
            <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-4xl mx-auto">
              منصة صحتي تجمع بين الخبرة الطبية والتقنيات الذكية لتمنحك رعاية صحية متكاملة في أي وقت وأي مكان
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-xl px-12 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-gradient mb-2">٣ ثوانٍ</div>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-gradient mb-2">٢٤/٧</div>
                <div className="text-gray-600">متاح على مدار الساعة</div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-gradient mb-2">١٠٠٪</div>
      ...
      <section id="vision" className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 scroll-reveal">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">رؤيتنا ومهمتنا</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              نسعى لتحويل تجربة الرعاية الصحية من خلال الذكاء الاصطناعي والابتكار التقني
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="border-0 shadow-lg hover-lift scroll-reveal">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  أن نكون المنصة الرائدة في المنطقة لتوجيه المرضى إلى أفضل رعاية صحية مناسبة لحالتهم، مدعومة بأحدث
            ...
            <Card className="border-0 shadow-lg hover-lift scroll-reveal">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  تمكين المرضى من اتخاذ قرارات صحية مدروسة من خلال توفير توجيه ذكي وسريع ودقيق إلى أفضل المستشفيات
                  والأطباء المتخصصين في منطقتهم.
                </p>
      ...
      <section id="features" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 scroll-reveal">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">لماذا تختار صحتي؟</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              منصة متطورة تجمع بين الذكاء الاصطناعي وخبرة الأطباء لتوفير أفضل رعاية صحية
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "تحليل دقيق للأعراض باللغة العربية مع فهم اللهجات المحلية المختلفة",
                color: "teal",
              },
              {
                icon: MapPin,
                title: "أقرب المستشفيات",
                description: "عرض المستشفيات والعيادات الأقرب إليك مع معلومات التقييم والمسافة",
                color: "blue",
              },
              {
                icon: Zap,
                title: "استجابة فورية",
                description: "احصل على التوجيه المناسب في أقل من ٣ ثوانٍ مع خيارات الحجز المباشر",
                color: "green",
              },
              {
                icon: Mic,
                title: "تسجيل صوتي ذكي",
                description: "سجل أعراضك بصوتك باللغة العربية مع إمكانية المراجعة والتعديل",
                color: "purple",
              },
              {
                icon: Shield,
                title: "أمان متقدم",
                description: "حماية كاملة لبياناتك الصحية مع التشفير المتقدم وسياسة خصوصية صارمة",
                color: "red",
              },
              {
                icon: Users,
                title: "مراجعة طبية",
                description: "جميع التوصيات تخضع لمراجعة الأطباء المتخصصين لضمان الدقة والأمان",
                color: "orange",
              },
            ].map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover-lift scroll-reveal">
                <CardContent className="p-6 text-center">
                  <div
      ...
      <section id="technology" className="py-20 px-4 bg-gray-900 text-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 scroll-reveal">
            <h2 className="text-4xl font-bold mb-6">التقنية والذكاء الاصطناعي</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              نستخدم أحدث تقنيات الذكاء الاصطناعي والتعلم الآلي لتحليل الأعراض وتوجيه المرضى
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-reveal">
              <h3 className="text-3xl font-bold mb-8 text-gradient">معمارية الذكاء الاصطناعي</h3>
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    icon: MapPin,
                    title: "الترتيب الذكي",
                    description: "ترتيب المستشفيات حسب التخصص والمسافة والتقييم",
                  },
                ].map((item, index) => (
            ...
            <Card className="border-0 bg-white/10 scroll-reveal">
              <CardContent className="p-8">
                <h4 className="text-2xl font-bold mb-6 text-center text-white">مؤشرات الأداء</h4>
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-teal-400 mb-2">٩٩.٩٪</div>
                    <div className="text-gray-300">وقت التشغيل</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-cyan-400 mb-2">٩٥٪</div>
                    <div className="text-gray-300">دقة التشخيص</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-emerald-400 mb-2">٢.٨ث</div>
                    <div className="text-gray-300">متوسط الاستجابة</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-400 mb-2">٤.٨/٥</div>
      ...
      <section id="how-it-works" className="py-20 px-4 bg-teal-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 scroll-reveal">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">كيف يعمل صحتي؟</h2>
            <p className="text-xl text-gray-600">رحلة بسيطة من الأعراض إلى أفضل رعاية صحية</p>
          </div>
            ...
            {[
              {
                number: "١",
                title: "صف أعراضك",
                description: "اكتب أو سجل أعراضك باللغة العربية. منصتنا تفهم اللهجات المختلفة وتحلل المعلومات بدقة",
                icon: MessageSquare,
                color: "teal",
              },
              {
                number: "٢",
                title: "التحليل الذكي",
                description: "الذكاء الاصطناعي يحلل حالتك ويحدد مستوى الخطورة والتخصص المناسب في ثوانٍ معدودة",
                icon: Brain,
                color: "blue",
              },
              {
                number: "٣",
                title: "أفضل الخيارات",
                description: "احصل على قائمة بأفضل المستشفيات والأطباء القريبين منك مع التقييمات والمسافات",
                icon: Hospital,
                color: "green",
              },
              {
                number: "٤",
                title: "احجز واتصل",
                description: "اختر الخيار الأنسب واحجز موعدك مباشرة أو اتصل بالمستشفى فوراً",
                icon: Phone,
                color: "purple",
              },
            ].map((step, index) => (
      ...
      <section className="py-16 px-4 bg-red-50 border-y-2 border-red-200">
        <div className="container mx-auto max-w-4xl text-center scroll-reveal">
          ...
          <p className="text-lg text-red-700 leading-relaxed max-w-3xl mx-auto mb-6">
            صحتي هي أداة مساعدة لاتخاذ القرار وليست بديلاً عن التشخيص الطبي المهني. في حالات الطوارئ، اتصل فوراً بخدمات
      ...
      <section className="py-20 px-4 teal-gradient text-white">
        <div className="container mx-auto max-w-4xl text-center scroll-reveal">
          ...
          <p className="text-xl mb-8 opacity-90">
            انضم إلى آلاف المستخدمين الذين يثقون في صحتي للحصول على أفضل رعاية صحية
          </p>
